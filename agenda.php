	...
	<div class="content-wrapper clearfix">
		...
		<section class="center min-max agenda agenda-alt clearfix">
			...
			<div class="info-graphic">
				...
				<p class="agenda-custom">Taubman Center, College for Creative Studies Detroit, MI<a href="http://g.co/maps/abps8" class="address" target="_blank">(460 W Baltimore in Midtown Detroit)</a><span>(Contact <a href="mailto:randbregistration@umich.edu">randbregistration@umich.edu</a> for tickets)</span></p>
