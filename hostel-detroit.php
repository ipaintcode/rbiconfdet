					...
					<ol>
						...
						<li class="active"><a href="racquetup.php">Detroit Impact</a>
							<ul class="main-nav-secondary">
								...
								<li class="active"><a href="hostel-detroit.php">Hostel Detroit</a></li>
	...
	<div class="content-wrapper clearfix">
		...
		<section class="center min-max keynotes clearfix">
			...
			<article>
				...
				<p>Hostel Detroit provides safe, affordable accommodations in Detroit while educating patrons about the city.</p>
				
				<p>The team developed a market analysis study to understand Hostel Detroit’s competition and customer base. Additionally, the team identified potential partnerships that could boost occupancy and the recommended a pricing strategy that would attract customers in their target market.</p>
