					...
					<ol>
						...
						<li class="active"><a href="racquetup.php">Detroit Impact</a>
							<ul class="main-nav-secondary">
								...
								<li class="active"><a href="kiva-detroit.php">Kiva Detroit</a></li>
	...
	<div class="content-wrapper clearfix">
		...
		<section class="center min-max keynotes clearfix">
			...
			<article>
				...
				<p>Kiva Detroit is the first Kiva City, a program where Kiva works with community organizations in the United States to provide local small businesses with microloans.</p>
				
				<p>The team is identifying ways to promote Kiva’s unique services to the Detroit market and developing clear communication regarding the specific advantages of a Kiva loan. Additionally, the team recommended how to foster partnerships in the city by identifying organizations that provide small business support and developing a database to capture the skills and expertise of Kiva’s volunteer network.</p>
