			...
			<div class="header-inner center min-max clearfix">
				...
				<nav class="main-nav">
					...
					<ol>
						...
						<li class=""><a href="">Detroit Impact</a></li>
						<li class=""><a href="https://www.eventbrite.com/event/1290514965?utm_source=eb_email&utm_medium=email&utm_campaign=new_eventv2&utm_term=eventurl_text">Register</a></li>
					</ol>
