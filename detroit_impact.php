...
<head id="www-sitename-com" data-template-set="html5-reset">
	...
	<title>Revitalization &amp; Business Initiative | Raquet Up</title>
...
<div class="wrapper"><!-- not needed? up to you: http://camendesign.com/code/developpeurs_sans_frontieres -->
					...
					<ol>
						...
						<li class="active"><a href="racquetup.php">Detroit Impact</a>
							<ul class="main-nav-secondary">
								<li class="active"><a href="agenda.php">one</a></li>
								<li class=""><a href="idealab.php">two</a></li>
								<li class=""><a href="panels.php">three</a></li>
								<li class=""><a href="keynote.php">four</a></li>
							</ul>	
						</li>
	...
	<div class="content-wrapper clearfix">
		...
		<section class="center min-max keynotes clearfix">
			...
			<aside>
				<img src="_/img/suitcase.png" alt="Gilbert">
			</aside>
			<article>
				<h5>Summary:</h5>
				
				<p>Racquet Up is an after-school youth development program that uses the sport of squash, fitness development, academic tutoring and support to make a difference in the lives of Detroit youth.</p>
				
				<p>The goal of the Racquet Up team was to understand and quantify the value of the Racquet Up brand through market studies, industry research, and visual brand mapping. The team also identified ways in which the organization can better position and promote itself to sustain and grow the program. Racquet Up is an after-school youth development program that uses the sport of squash, fitness development, academic tutoring and support to make a difference in the lives of Detroit youth.</p>
