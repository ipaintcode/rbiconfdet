					...
					<ol>
						...
						<li class="active"><a href="racquetup.php">Detroit Impact</a>
							<ul class="main-nav-secondary">
								...
								<li class="active"><a href="whole-foods-market.php">Whole Foods Market</a></li>
	...
	<div class="content-wrapper clearfix">
		...
		<section class="center min-max keynotes clearfix">
			...
			<article>
				...
				<p>Whole Foods Market is the world’s largest natural and organic grocery store and is opening its first Detroit location.</p>
				
				<p>The team has been working with Whole Foods Market to analyze its Detroit community engagement efforts. The team led a collaborative brainstorming session with community leaders to understand the links between business, food and a city that will be combined with research, case study analysis, and employee interviews to produce recommendations for how Whole Foods Market can most effectively establish a positive partnership with the city of Detroit.</p>
