					...
					<ol>
						...
						<li class="active"><a href="racquetup.php">Detroit Impact</a>
							<ul class="main-nav-secondary">
								...
								<li class="active"><a href="fresh-corner-cafe.php">Fresh Corner Caf&eacute;</a></li>
	...
	<div class="content-wrapper clearfix">
		...
		<section class="center min-max keynotes clearfix">
			...
			<article>
				...
				<p>Fresh Corner Caf&eacute; provides fresh prepared foods to local corner stores throughout the city, making things like vegetables and healthy meals available in places many working people depend on for food but often lack healthy options that aren&#x27;t pre-packaged.</p>
				
				<p>The team working with Fresh Corner Cafe has created a marketing strategy for a newly developed catering operation. This second revenue stream will supplement FCC's current operations of providing high-quality healthy meals sold in areas that have limited access to healthy foods.</p>
